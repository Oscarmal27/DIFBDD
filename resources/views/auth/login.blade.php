...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>DIF MUNICIPAL ASC</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Inicia una sesión nueva</p>
      ...
      <p class="mb-0">
        <a href="register.html" class="text-center">Registrarse como nuevo</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
